// CA oficial de Supabase (intermedia + raiz "Supabase Root 2021 CA"). Cert PUBLICO, no secreto.
// Permite verificacion REAL del cert del pooler (rejectUnauthorized:true) sin leer disco en runtime
// (robusto en Vercel). Capturada del pooler con openssl s_client -starttls postgres -showcerts.
